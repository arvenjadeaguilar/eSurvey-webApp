...
<table class="table table-bordered table-striped list">
    <thead>
        <tr>
			...
			<th>
				<a href="" ng-click="sortBy('start')">Start</a>
				<i ng-show="listOptions.sort=='start' && listOptions.order=='asc'" class="glyphicon glyphicon-chevron-up pull-right"></i>
				<i ng-show="listOptions.sort=='start' && listOptions.order=='desc'" class="glyphicon glyphicon-chevron-down pull-right"></i>
			</th>
		
			<th>
				<a href="" ng-click="sortBy('end')">End</a>
				<i ng-show="listOptions.sort=='end' && listOptions.order=='asc'" class="glyphicon glyphicon-chevron-up pull-right"></i>
				<i ng-show="listOptions.sort=='end' && listOptions.order=='desc'" class="glyphicon glyphicon-chevron-down pull-right"></i>
			</th>
